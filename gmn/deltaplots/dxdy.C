...
TH1D *h_atime, *h_W, *h_W2, *h_W2recon, *h_dx, *h_dy, *h_KE_p, *h_KE_low, *h_Diff, *h_X, *h_Y, *h_E_eloss;
TH1D *h_W_cut, *h_W_fcut, *h_vz_cut;
TH1D *h_Q2, *h_E_ep, *h_E_pp;
TH1D *h_dy, *h_dy_cut, *h_dx, *h_dx_cut, *h_dx_wcut, *h_dx_fcut;
...
void dxdy(){
	...
	h_dy = new TH1D("hdy_HCal",Form("dy (NO CUTS) - SBS = %i%%, %s, Run %i; y_{HCal} - y_{exp} (m);", sbsfieldscale, run_target.Data(), runnum), 250, -1.25,1.25);
	h_dy_cut = new TH1D("hdy_HCal_cut",Form("dy (Basic Cuts) - SBS = %i%%, %s, Run %i; y_{HCal} - y_{exp} (m);", sbsfieldscale, run_target.Data(), runnum), 250, -1.25,1.25);  
