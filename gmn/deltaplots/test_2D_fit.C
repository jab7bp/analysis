...
Double_t test_2D_fit(Double_t th = 200)
{
...
// Set starting values and step sizes for parameters
   static Double_t vstart[5] = {0.2, 0.5 , -0.2, 0.1 , 0.1};
   static Double_t step[5] = {0.05 , 0.05 , 0.05 , 0.05, 0.005};
   gMinuit->mnparm(0, "x1", vstart[0], step[0], 0, 0.4, ierflg);
   gMinuit->mnparm(1, "y1", vstart[1], step[1], 0.2, 0.6, ierflg);
   gMinuit->mnparm(2, "x2", vstart[2], step[2], -0.4, 0.0, ierflg);
   gMinuit->mnparm(3, "y2", vstart[3], step[3], 0.08, 0.12, ierflg);
