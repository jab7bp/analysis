...
//Binning values
const Int_t nBins = 80; //Num bins for HCal E vs. Nucleon Mom (p) for 1000 evt/bin
...
//--------------------------------------------------
	...
	if( !calibrate ){
		...
		if( Nucleon_Select == "both"){
			...
			tpt_det_effs->AddText(" Efficiencies from Fit");
			tpt_det_effs->AddText("");
			tpt_det_effs->AddText("SBS4:");
			tpt_det_effs->AddText(Form("p: %0.1f%%, n: %0.1f%%", prot_det_eff_sbs4, neut_det_eff_sbs4));
			tpt_det_effs->AddText("");

			tpt_det_effs->AddText("SBS7:");
			tpt_det_effs->AddText(Form("p: %0.1f%%, n: %0.1f%%", prot_det_eff_sbs7, neut_det_eff_sbs7));
			tpt_det_effs->AddText("");

			tpt_det_effs->AddText("SBS8:");
			tpt_det_effs->AddText(Form("p: %0.1f%%, n: %0.1f%%", prot_det_eff_sbs8, neut_det_eff_sbs8));
			tpt_det_effs->AddText("");

			tpt_det_effs->AddText("SBS9:");
			tpt_det_effs->AddText(Form("p: %0.1f%%, n: %0.1f%%", prot_det_eff_sbs9, neut_det_eff_sbs9));
			tpt_det_effs->AddText("");

			tpt_det_effs->AddText("SBS14:");
			tpt_det_effs->AddText(Form("p: %0.1f%%, n: %0.1f%%", prot_det_eff_sbs14, neut_det_eff_sbs14));
